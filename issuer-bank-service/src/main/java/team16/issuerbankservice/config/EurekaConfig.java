package team16.issuerbankservice.config;
...
public class EurekaConfig {
    ...
    public DiscoveryClient.DiscoveryClientOptionalArgs discoveryClientOptionalArgs() throws NoSuchAlgorithmException, IOException {
        ...
        ClassPathResource resource1 = new ClassPathResource("issuer-bank-service.p12");
        ...
        builder.withClientName("issuer-bank-service");
